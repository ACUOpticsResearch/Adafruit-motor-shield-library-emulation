/******************************************************************
Adafruit_Motorshield_standin.h
...
Since all functions are to be emulated, this header file is essentially
the same as the original.
Changes: Adafruit PWM Servo library name has been emulated, too and the name
has been changed to the name of the emulated library
...
#include <inttypes.h>
#include <Wire.h>
#include "utility/Adafruit_MS_PWMServoDriver_standin.h"
