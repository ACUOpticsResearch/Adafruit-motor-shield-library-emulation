/******************************************************************
Adafruit_Motorshield_standin.cpp
copied/edited by Darby Hewitt 5/24/2016

This library emulates the communication to/from the Adafruit motorshield
without actually requiring a Motor Shield.

The class and method definitions in this file must emulate the behavior of
the actual Adafruit Motor Shield. This will mostly require appropriate delays
to be built in to class methods.
...
#endif
#include <Wire.h>
#include "Adafruit_MotorShield_standin.h"
#include <Adafruit_MS_PWMServoDriver_standin.h>
